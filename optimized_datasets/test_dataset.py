...
from librosa.feature import spectral_centroid, spectral_bandwidth, spectral_rolloff, zero_crossing_rate
...
def train_nn(h5_folder):
    """
    The train_nn function takes a H5 folder containing the songs
    ...
    """
    features, labels = load_data(h5_folder)
